...
def pseudo_random_ds(test_session):
    return DataChain.from_records(
        [
            {"sys__id": 1, "sys__rand": 5879675686166179356, "fib": 0},
            {"sys__id": 2, "sys__rand": 1072763634206539916, "fib": 1},
            {"sys__id": 3, "sys__rand": 7470878726525325522, "fib": 1},
            {"sys__id": 4, "sys__rand": 5291421404395990161, "fib": 2},
            {"sys__id": 5, "sys__rand": 3788858646844612545, "fib": 3},
            {"sys__id": 6, "sys__rand": 5386753411829147253, "fib": 5},
            {"sys__id": 7, "sys__rand": 6728313339644935000, "fib": 8},
            {"sys__id": 8, "sys__rand": 9104853878801776163, "fib": 13},
            {"sys__id": 9, "sys__rand": 8521762708321943183, "fib": 21},
            {"sys__id": 10, "sys__rand": 6715195136789658794, "fib": 34},
        ],
        session=test_session,
        schema={"sys": Sys, "fib": int},
    )
